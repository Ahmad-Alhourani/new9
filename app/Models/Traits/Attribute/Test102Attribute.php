...
trait Test102Attribute
{
    ...
    /**
     * @return string  test102
     */
    public function getEditButtonAttribute()
    {
        return '<a href="' .
            route('admin.test102.edit', $this) .
            '" data-toggle="tooltip" data-placement="top" title="' .
    ...
    {
        return '<a href="' .
            route('admin.test102.destroy', $this) .
            '"
			 data-method="delete"
    ...
    {
        return '<div
       class="btn-group btn-group-sm" test102="group" aria-label="Test102 Actions">
	   		 ' .
            $this->view_button .
            '
			  ' .
